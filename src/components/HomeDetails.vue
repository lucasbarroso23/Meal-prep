    ...
    <v-layout column>
      ...
      <v-flex>
        ...
        <p class="subheading mt-3">
          ...
          suscipit ducimus. Distinctio quidem pariatur, nobis minima aliquid
          quae ullam praesentium porro voluptatem tempora architecto, libero ex
          inventore, error modi quisquam?
        </p>
      </v-flex>
      <v-flex>
        <div class="headline mt-3">Lorem Ipsum</div>
        <p class="subheading mt-3">
          ...
          repellendus. Exercitationem ratione labore cupiditate optio
          dignissimos reprehenderit odio officiis, veniam suscipit in natus ex
          eius rem consequuntur consequatur minima.
        </p>
        <p class="subheading mt-3">
